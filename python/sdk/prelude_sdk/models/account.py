...
class Account:
    ...
    def __init__(self, profile='default', hq='https://detect.preludesecurity.com', keychain_location=os.path.join(Path.home(), '.prelude', 'keychain.ini')):
        self.profile = profile
        self.hq = hq
        self.headers = dict()
        self.keychain_location = keychain_location

    def configure(self, account_id, token, hq='https://detect.preludesecurity.com', profile='default'):
    ...
    def read_keychain_config(self, hq='https://detect.preludesecurity.com', profile='default'):
