...
$TEST_ID="07d31938-92fa-40aa-b8af-77a54055f481"
$TEST_INTRO="Will your computer quarantine a malicious executable file?
...
[+] Applicable CVE(s): CVE-2017-11882
[+] ATT&CK mappings: T1486"
$TEST_SUCCESS="Your computer detected and responded to a malicious executable dropped on the disk"
...
executable on the disk. If you have security controls in place that you suspect should have protected your
