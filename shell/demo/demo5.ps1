...
This test will attempt to download a defanged malicious file to your disk - containing a signature for the Colour-Blind malware used in a recent supply chain attack - to see how your endpoint defenses will respond. 
